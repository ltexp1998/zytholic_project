...
st.markdown("""<style>#style-proposition {text-shadow: 0 0 3px #ff0000, 0 0 3px #0000ff; color: white; border : solid white 1px; padding: 0.5em; padding-bottom : 25em} </style> """, unsafe_allow_html=True)

st.write('<style>div.row-widget.stRadio> div{display: flex; flex-flow: row; justify-content: center;}</style>', unsafe_allow_html=True)
...
st.markdown('<h2 style="text-shadow: 0 0 3px #ff0000, 0 0 3px #0000ff; color: white; text-align: center;font-size: 2em; padding-bottom: 1em;text-transform: capitalize;">help yourself to discover new beer</h2>', unsafe_allow_html=True)
...
st.sidebar.markdown('<p style=" padding-top: 1em"><span style=" font-weight: bold;">Enter</span> the name of a beer</p>', unsafe_allow_html=True)
st.sidebar.markdown('<p style=""><span style=" font-weight: bold;">OR</span> Choose a Style (ex : IPA)</p>', unsafe_allow_html=True)
st.sidebar.markdown('<p style=""><span style="font-weight: bold;">OR</span> Choose a Taste (ex : Hoppy)</p>', unsafe_allow_html=True)
...
st.markdown('<h2 style="text-shadow: 0 0 3px #ff0000, 0 0 3px #0000ff; color: white; border : solid white 1px; padding : 0.5em ">Enter the name of a beer :</h2>',unsafe_allow_html=True)
